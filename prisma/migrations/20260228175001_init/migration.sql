...
CREATE TABLE "ProjectRewrite" (
    ...
    CONSTRAINT "ProjectRewrite_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "ProjectRewrite" ADD CONSTRAINT "ProjectRewrite_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
